...
public class Lv0_2024_03_11_No1 {
    public String[] solution(String myString) {
        myString = myString.trim().replace("x"," ");
        myString = myString.trim().replace("\\s+", " ");
    ...
    public static void main(String[] args) {
        Lv0_2024_03_11_No1 s = new Lv0_2024_03_11_No1();
        Scanner sc = new Scanner(System.in);
        String str1 = sc.nextLine();
        String[] arrans = s.solution(str1);
        for(String a : arrans){
            System.out.print(a+",");
        }
    }

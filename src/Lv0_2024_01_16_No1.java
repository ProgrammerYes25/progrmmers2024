...
public class Lv0_2024_01_16_No1 {
    public int solution(int a, int b, int c, int d) {
        ...
        Map.Entry<Integer, Integer> mine = null;
        Set< Map.Entry<Integer, Integer>> hashset =hash.entrySet();
        if(hash.size()==1){
            for(Map.Entry<Integer, Integer> e: hashset){
                answer= 1111*e.getKey();
            }
        }else if(hash.size()==2){
            int[] tmep = new int[2];
            int i=0, num =0, maxKey=0;
            for(Map.Entry<Integer, Integer> e: hashset){
                if(e.getValue() == 3){
                    maxKey =e.getKey();
                    i++;
            ...
            for(Map.Entry<Integer, Integer> e: hashset){
                if(mine == null || e.getKey() > mine.getKey()){
                    mine = e;
                }
            }
            answer = mine.getKey();
    ...
    public static void main(String[] args) {
        Lv0_2024_01_16_No1 s = new Lv0_2024_01_16_No1();
        Scanner sc = new Scanner(System.in);
        int x1 = sc.nextInt();
        int x2 = sc.nextInt();
        int x3 = sc.nextInt();
        int x4 = sc.nextInt();
        int arrans = s.solution(x1, x2, x3, x4);
